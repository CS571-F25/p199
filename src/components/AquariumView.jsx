...
export default function AquariumView({ children, plantLife, pressure }) {
  ...
  // Select background image based on plantLife %
  ...
  // Make higher pressure = darker environment
  // You can tune the multipliers if you want.
  const r = 30 * (1 - p / 100);
  const g = 110 * (1 - p / 100);
  const b = 180 * (1 - p / 100);

  // Water darkens by becoming more opaque
